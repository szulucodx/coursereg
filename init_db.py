    ...
    try:
        statements = [
          ...
          'DROP TABLE IF EXISTS Section',
            ...
            ''',
            'CREATE INDEX idx_enrollment_student_status_section ON Enrollment (Student_ID, Status, Section_ID)',
            'CREATE INDEX idx_enrollment_section_status ON Enrollment (Section_ID, Status)',
            'CREATE INDEX idx_enrollment_student_section_status ON Enrollment (Student_ID, Section_ID, Status)',
            'CREATE UNIQUE INDEX uq_enrollment_student_section_active ON Enrollment (Student_ID, Section_ID, Status)',
            '''
        ...
        print('✅ Tables created: Student, Admin, Department, Lecturer, Course, Section, CoursePrerequisite, Enrollment')
        print('\n📋 Sample Data Added:')
